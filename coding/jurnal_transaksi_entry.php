<?php
	...
	if (isset($_POST["txtOp"]))
	{
        ...
        {
            if ($_SESSION["op"] == "1"){
            	$_SESSION["jurnal_code"] = getKodeJurnalTransaksi($hostDB, $userDB, $passDB, $nameDB); 
            	updateKodeJurnalTransaksi($hostDB, $userDB, $passDB, $nameDB);  
            }
	...
	else
	{
		...
		if ($_SESSION["op"] == "1")
		{
            ...
            $_SESSION["btnLabel"] = "Save Data Jurnal Transaksi";
            $_SESSION["lblTitle"] = "New Data Jurnal Transaksi";
        }
        elseif($_SESSION["op"] == "2" || $_SESSION["op"]=="3" || $_SESSION["op"]=="4")
        {
			...
			{
				$_SESSION["modeView"] = "1";
                $_SESSION["btnLabel"] = "Update Data Jurnal Transaksi";
                $_SESSION["lblTitle"]  = "Edit Data Jurnal Transaksi";
			}
			else
			{
				$_SESSION["modeView"] = "2";
                if ($_SESSION["op"] == "3")
                {
                    $_SESSION["btnLabel"] = "Delete Data Jurnal Transaksi";
                    $_SESSION["lblTitle"]  = "Delete Data Jurnal Transaksi";
                }
                else
                    $_SESSION["lblTitle"]  = "View Data Jurnal Transaksi";
			}
        }
        else    
            eror("invalid op");
...
{	
    ...
    $sqlCmd = "SELECT KodeReff, Reff FROM mst_reff where tipeReff =6"; 
    ...
    $sqlCmd = "SELECT perkiraan_code, perkiraan_name FROM mst_perkiraan where stac=1 and not(stkas=1 or stbank=1)"; 
...
function frmSubmit(){ 
    ...
    if (op == "1")
        msg = 'Confirm add Data Jurnal Transaksi ?';
    else if (op == "2")
        msg = 'Confirm edit Data Jurnal Transaksi ?';
    else if (op == "3")
        msg = 'Confirm delete Data Jurnal sTransaksi ?';
    else
    {
        msg = 'invalid op';
        return false;
