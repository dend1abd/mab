				...
				<td colspan=2 valign="top">  
					<table width="100%"  cellspacing="1" bgcolor="silver" id="tblJurnalDetail" >  
						<tr bgcolor="white"  align='center'>
							<td align="right"><input class="button" type="button" name="btnLookUp" value="..." onClick="lookup();" /></td>
							<td><?php echo getTextBox(1, "txtDetailPerkiraanCode0", "", 20, 20, ""); echo getTextBox(1, "txtDetailPerkiraan0", "", 20, 20, ""); ?></td> 
							<td><?php echo getTextBox(1, "txtDetailJumlah0", "", 20, 20, $clsformatInteger); ?></td> 
							<td><?php echo getDatePic(1, "txtDetailTglDok0", "", ""); ?></td>
							<td><?php echo getTextBox(1, "txtDetailNoDok0", "", 20, 20, ""); ?></td>
							<td><?php echo getTextBox(1, "txtDetailKetDok0", "", 20, 20, ""); ?></td> 
						...
						<?php
							...
							while ($datadetail = mysql_fetch_array($rsdetail)) 
							{
								...
								echo getTextBox(1, "txtDetailPerkiraanCode$i", $datadetail[0], 20, 20, ""); echo getTextBox(1, "txtDetailPerkiraan$i", $datadetail[1], 20, 20, "");
								echo "</td>";
								
								echo "<td align='center'>";
								echo getTextBox(1, "txtDetailJumlah$i", $datadetail[2], 20, 20, "");
								echo "</td>";
								
								echo "<td align='center'>";
								echo getTextBox(1, "txtDetailTglDok$i", $datadetail[4], 20, 20, "");
								echo "</td>";
								
								echo "<td align='center'>";
								echo getTextBox(1, "txtDetailNoDok$i", $datadetail[3], 20, 20, "");
								echo "</td>";
								
								echo "<td align='center'>";
								echo getTextBox(1, "txtDetailKetDok$i", $datadetail[5], 20, 20, "");
								echo "</td>";
						...
						<tr bgcolor="white">
							...
							<td align="center">
							<?php  echo getTextBox($_SESSION["modeView"], "txtSubAmount","", 20, 20, ""); ?> 
