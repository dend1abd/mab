...
<td colspan="2">Nota Order Pembelian</td> 
</tr>
					...
					<table width="100%"  cellspacing="1" bgcolor="silver" id="tblJurnalDetail" >  
						...
						<?php
							...
							while ($datadetail = mysql_fetch_array($rsdetail)) 
							{
								...
								echo "<td align='right'>";
								echo getTextBox(2, "txtDetailharga_beli$i", setNumber($datadetail["harga_beli"]), 50, 15, $clsformatInteger . " readonly");
								echo "</td>";
								...
								echo "<td align='right'>";
								echo getTextBox(2, "txtDetailsub_total$i", setNumber($datadetail["sub_total"]), 50, 15, $clsformatInteger . " readonly");
								echo "</td>";
								
								echo "<td align='right'>";
								echo getTextBox(2, "txtDetaildisc_persen$i", setNumber($datadetail["disc_persen"]), 50, 5, $clsformatInteger . " readonly");
								echo "% | ";
								echo getTextBox(2, "txtDetaildisc_amount$i", setNumber($datadetail["disc_amount"]), 50, 15, $clsformatInteger . " readonly"); 
								echo "</td>";
								
								echo "<td align='right'>";
								echo getTextBox(2, "txtDetailtotal$i", setNumber($datadetail["total"]), 50, 15, $clsformatInteger . " readonly"); 
								echo "</td>"; 
						...
						<tr bgcolor="white" class='font10black'>
							...
							<td align="right">
							<?php  echo getTextBox(2, "txtsub_total", setNumber($_SESSION["sub_total"]), 20, 15, $clsformatInteger); ?> 
							<?php  echo getHiddenBox(2, "txtJmlItem","<?php echo $jmlItem;?>"); ?>
				...
				<td width=50%> <!-- kiri-->
					<table width="100%">   
						<tr class="font10black"> 
						  ...
						  <td width="1%" style="height: 23px">:</td>
						  <td style="height: 23px" align="right"> <?php  echo getTextBox(2, "txtdisc_persen", $_SESSION["disc_persen"], 50, 3, $clsformatInteger) . "% "; echo " | "; echo getTextBox(2, "txtdisc_amount", setNumber($_SESSION["disc_amount"]), 50, 20, $clsformatInteger); ?> 
						  </td>
						</tr >
						<tr class="font10black"> 
						  <td width="3%" style="height: 23px"></td>
						  ...
						  <td width="1%" style="height: 23px">:</td>
						  <td style="height: 23px" align="right"> <?php  echo getTextBox(2, "txtppn_persen", $_SESSION["ppn_persen"], 50, 3, $clsformatInteger) . "% "; echo " | ";echo getTextBox(2, "txtppn_amount", setNumber($_SESSION["ppn_amount"]), 50, 20, $clsformatInteger); ?> 
						  </td>
						</tr > 
						<tr class="font10black"> 
						  <td width="3%" style="height: 23px"></td>
						  ...
						  <td width="1%" style="height: 23px">:</td>
						  <td style="height: 23px" align="right"> <?php  echo getTextBox(2, "txttotal", setNumber($_SESSION["total"]), 50, 30, $clsformatInteger . " readonly"); ?> </td>
						</tr >
				...
				<td > <!-- kanan-->
					<table width="100%"> 
						...
						<tr class="font10black"> 
						  ...
						  <td width="1%" style="height: 23px">:</td>
						  <td style="height: 23px" align="right"> <?php  echo getTextBox(2, "txtbayar", setNumber($_SESSION["bayar"]), 50, 30, $clsformatInteger); ?>
						</td>
						</tr >
						<tr class="font10black"> 
						  <td width="3%" style="height: 23px"></td>
						  ...
						  <td width="1%" style="height: 23px">:</td>
						  <td style="height: 23px" align="right"> <?php  echo getTextBox(2, "txtsisa", setNumber($_SESSION["sisa"]), 50, 30, $clsformatInteger . " readonly"); ?> </td>
						</tr >
						<tr class="font10black"> 
						  <td width="3%" style="height: 23px"></td>
						  <td width="30%" style="height: 23px">Keterangan</td>
						  <td width="1%" style="height: 23px">:</td>
						  <td style="height: 23px" > <?php  echo getTextBox(2, "txtketerangan", $_SESSION["keterangan"], 255, 40, ""); ?> </td>
						</tr >
					</table>
				</td> 
			</tr> 
