<?php 
	...
	cekSession();
	$pageTitle = "Laporan Order Penjualan Barang";
	...
	$sql = "select a.transaksi_tgl, a.transaksi_kode, a.contact_code, a.sales_code, b.contact_name as customer, c.contact_name as sales, d.*, a.kode_divisi from trx_master a ";
	...
	$sql = $sql . "where a.transaksi_tipe=5 ";
