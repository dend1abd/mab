<?php
	...
	else
	{
		...
		if ($_SESSION["op"] == "1")
		{
            ...
            $_SESSION["btnLabel"] = "Save Data Order Pembelian";
            $_SESSION["lblTitle"] = "New Data Order Pembelian";
        }
        elseif($_SESSION["op"] == "2" || $_SESSION["op"]=="3" || $_SESSION["op"]=="4")
        {
			...
			{
				$_SESSION["modeView"] = "1";
                $_SESSION["btnLabel"] = "Update Data Order Pembelian";
                $_SESSION["lblTitle"]  = "Edit Data Order Pembelian";
			}
			else
			{
				$_SESSION["modeView"] = "2";
                if ($_SESSION["op"] == "3")
                {
                    $_SESSION["btnLabel"] = "Delete Data Order Pembelian";
                    $_SESSION["lblTitle"]  = "Delete Data Order Pembelian";
                }
                else
                    $_SESSION["lblTitle"]  = "View Data Order Pembelian";
			}
        }
        else    
            eror("invalid op");
...
{	
	...
	header("location:global_notification.php?from=purchase_order" .$tambahanUrl. "&strMsg=" . htmlspecialchars($strTemp));
...
function frmCetak(){
	...
	//alert(kode );
	window.open("purchase_order_cetak.php?kode="+kode, "cetak_jurnal_" + kode ,  "height=360, width=640, location=0,menubar=0,scrollbars=1,resizable=0, modal=yes");
...
function frmSubmit(){ 
    ...
    if (op == "1")
        msg = 'Confirm add Data Order Pembelian ?';
    else if (op == "2")
        msg = 'Confirm edit Data Order Pembelian ?';
    else if (op == "3")
        msg = 'Confirm delete Data Order Pembelian ?';
    else
    {
        msg = 'invalid op';
        return false;
			...
			<tr>
				...
				<td > <!-- kanan-->
					<table width="100%"> 
						...
						<tr class="font10black"> 
						  <td width="3%" style="height: 23px"></td>
						  <td width="30%" style="height: 23px">Uang Muka</td>
						  <td width="1%" style="height: 23px">:</td>
						...
						<tr class="font10black"> 
						  <td width="3%" style="height: 23px"></td>
						  <td width="30%" style="height: 23px">Sisa Bayar</td>
						  <td width="1%" style="height: 23px">:</td>
