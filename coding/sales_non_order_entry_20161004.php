<?php
	...
	$tableGenDetail = "trx_jual_non_order_detail";
	$tableNameDetail = "trx_detail";	
	$pageTitle = "Penjualan non Order";
	$pagePrefix = "sales_non_order";
...
{	
	...
	header("location:sales_non_order_cetak.php?kode=" .$_SESSION["ID"]);
...
function frmCetak(){
	...
	//alert(kode );
	window.open("sales_non_order_cetak.php?kode="+kode, "sales_order_" + kode ,  "height=360, width=640, location=0,menubar=0,scrollbars=1,resizable=0, modal=yes");
