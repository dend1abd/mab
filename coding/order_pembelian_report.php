<?php 
	...
	if (isset($_POST["txtTgl1"])){
		...
		if ($tipeLap == "1"){
			...
			if ($stOrder != ""){
				$sql = $sql . "and a.stOrder='$stOrder' ";
			}

		}
		else{
			$sql = "select a.transaksi_kode, transaksi_tgl, a.contact_code, b.contact_name, a.sales_code, c.contact_name as sales, e.product_code, e.product_name, e.qty, e.harga_beli, e.disc_amount, e.sub_total, e.total, d.reff, e.ket_detail from trx_master a ";
...
<title>Lapora Order Pembelian</title>
</head>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1">
	<tr>
		<td class="font12Bold" style="height: 24px"> Laporan Order Pembelian</td>
	</tr> 
	<tr>
			...
			<table >
				...
				<tr class="font10black"> 
					...
					<td>
						...
						&nbsp;Status Order&nbsp;:&nbsp;
						<?php echo getComboBox(1, "txtStOrder", $stOrder, $rsStatus, ""); ?>
					</td>
				</tr>
				<tr class="font10black"> 
					<td>&nbsp;</td>
