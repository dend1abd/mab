<?php
	...
	else
	{
		...
		if ($_SESSION["op"] == "1")
		{
            ...
            $_SESSION["lblTitle"] = "New Data Warna";
        }
        elseif($_SESSION["op"] == "2" || $_SESSION["op"]=="3" || $_SESSION["op"]=="4")
        {
			...
			if ($_SESSION["op"] == "2")
			{
                ...
                $_SESSION["lblTitle"]  = "Edit Data Warna";
			}
			else
			{
				$_SESSION["modeView"] = "2";
                if ($_SESSION["op"] == "3")
                {
                    ...
                    $_SESSION["lblTitle"]  = "Delete Data Warna";
                }
                else
                    $_SESSION["lblTitle"]  = "View Data Warna";
			}
        }
        else    
            eror("invalid op");
...
{	
	...
	header('location:global_notification.php?from=warna&strMsg=' . htmlspecialchars($strTemp));
...
<tr class="font10black">
          ...
          <td style="height: 23px">  Kode Warna</td>
          <td style="height: 23px">:</td>
