...
and a.transaksi_tgl <= NOW() ";
	...
	$sql = $sql . "and 1<> 1 order by transaksi_tgl, transaksi_kode"; 
	
	}
	else{
		$sql = "SELECT no_invoice, tgl_invoice, jml_invoice, telah_bayar, jml_hutang as piutang, kode_customer, nama_customer, jml_retur, kode_wilayah, nama_sales, status_faktur FROM trx_kontrabon a WHERE a.transaksi_kode ='" .$_SESSION["ID"] . "'";
	}
