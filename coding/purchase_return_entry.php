...
{	
	...
	header("location:purchase_return_cetak.php?kode=" .$_SESSION["ID"]);
...
function frmCetak(){
	...
	//alert(kode );
	window.open("purchase_return_cetak.php?kode="+kode, "purchase_non_order_" + kode ,  "height=360, width=640, location=0,menubar=0,scrollbars=1,resizable=0, modal=yes");
