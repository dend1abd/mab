<?php 
	...
	cekSession();
	$tableWidth = "100%";
	$pageEdit = "purchase_non_order_entry.php";
	...
	$array2d[] = array("No Pembelian", "transaksi_kode", "left", "varchar", "10%", "notsum");		
	$array2d[] = array("Tgl Pembelian", "transaksi_tgl", "left", "varchar", "10%", "notsum");		
