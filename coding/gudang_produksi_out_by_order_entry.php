<?php
	...
	$_SESSION["errMsg"] 	= "";
	$_SESSION["transaksi_tipe"] ="11";
	
	$tableGen = "trx_gd_pro_out_by_order";
	$tableName = "trx_master";
	$tableGenDetail = "trx_gd_pro_out_by_order_det";
	$tableNameDetail = "trx_detail";	
	$pageTitle = "Pengeluaran Barang Hasil Produksi by Order";
...
function frmCetak(){
	...
	//alert(kode );
	window.open("gudang_produksi_out_by_order_cetak.php?kode="+kode, "faktur_" + kode,  "height=360, width=640, location=0,menubar=0,scrollbars=1,resizable=0, modal=yes");
}
	...
	<td height="250" valign="top" align="left">
		...
		<table width="100%">
			...
			<tr >
                ...
                <?php
                if ($_SESSION["op"] == "1")
					include "retrieve_order_gd_pro_out.php";
				else
				{
				?>
