<?php 
	...
	if (isset($_POST["txtTgl1"])){
		...
		$sql = $sql . "where tipe_jurnal in (5, 6, 7) and jurnal_date between '$tgl1' and '$tgl2'";
		//eror($sql);	
...
function frmNew(){  
    self.location="jurnal_transaksi_entry.php?op=1"; 
}
...
<table width="100%" border="0" cellpadding="2" cellspacing="1">
	<tr>
		<td class="font12Bold">List Jurnal Transaksi</td>
	</tr> 
	<tr>
		<td>		
			<table >
					...
					else
					{
						...
						while ($data = mysql_fetch_array($rs)) 
						{
							...
							<tr class='font10black' bgcolor='#ffffff'>
								...
								<td>
								<a href="jurnal_transaksi_entry.php?op=2&ID=<?php echo $data[0]?>">Edit</a> 
								|
								<a href="jurnal_transaksi_entry.php?op=3&ID=<?php echo $data[0]?>">Delete</a> 
								|
								<a href="jurnal_transaksi_entry.php?op=4&ID=<?php echo $data[0]?>">View</a> 
								</td>
							</tr>	
							<?php
						}
