<?php 
	...
	$sql = "select a.*, b.contact_name as customer, c.contact_name as sales from trx_master a ";
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#d29fec" align="left">
				...
				else
				{
					...
					while ($data = mysql_fetch_array($rs)) 
					{
						...
						$sumDisc2 = $sumDisc2 + $data["disc_amount2"];
						$sumDisc3 = $sumDisc3 + $data["disc_amount3"];
						...
						<tr class='font10black' bgcolor='#ffffff'>
							...
							<td align="right"><?php echo setNumber($data["disc_amount2"]) ?> </td>
							<td align="right"><?php echo setNumber($data["disc_amount3"]) ?> </td>
					...
					echo "<td align='right'><b>" . setNumber($sumDisc2) . "</b></td>";
					echo "<td align='right'><b>" . setNumber($sumDisc3) . "</b></td>";
