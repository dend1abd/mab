<?php
	...
	else
	{
		...
		if ($_SESSION["op"] == "1")
		{
            ...
            $_SESSION["lblTitle"] = "New Data Kota";
        }
        elseif($_SESSION["op"] == "2" || $_SESSION["op"]=="3" || $_SESSION["op"]=="4")
        {
			...
			if ($_SESSION["op"] == "2")
			{
                ...
                $_SESSION["lblTitle"]  = "Edit Data Kota";
			}
			else
			{
				$_SESSION["modeView"] = "2";
                if ($_SESSION["op"] == "3")
                {
                    ...
                    $_SESSION["lblTitle"]  = "Delete Data Kota";
                }
                else
                    $_SESSION["lblTitle"]  = "View Data Kota";
			}
        }
        else    
            eror("invalid op");
...
{	
	...
	header('location:global_notification.php?from=kota&strMsg=' . htmlspecialchars($strTemp));
...
<tr class="font10black">
          ...
          <td style="height: 23px">  Kode Kota</td>
          <td style="height: 23px">:</td>
          <td style="height: 23px"> <?php  echo getTextBox($_SESSION["modeView"], "txtKodeReff", $_SESSION["KodeReff"], 20, 20, ""); ?> </td>
</tr >
<tr class="font10black">
          <td></td>
          <td>  Nama Kota</td>
