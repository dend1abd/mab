...
$sql = "select 
a.transaksi_kode, b.kode_size1, b.qty_size1, 
b.product_code,
b.product_name,
b.kode_warna,
b.harga,
...
b.total,
b.ket_detail,
sum(IFNULL(b.qty,0) - IFNULL(c.qty,0)) as qty,
sum(IFNULL(b.qty_size1,0) - IFNULL(c.qty_size1,0)) as qty1,    
sum(IFNULL(b.qty_size2,0) - IFNULL(c.qty_size2,0)) as qty2,
sum(IFNULL(b.qty_size3,0) - IFNULL(c.qty_size3,0)) as qty3,
sum(IFNULL(b.qty_size4,0) - IFNULL(c.qty_size4,0)) as qty4,
sum(IFNULL(b.qty_size5,0) - IFNULL(c.qty_size5,0)) as qty5,
sum(IFNULL(b.qty_size6,0) - IFNULL(c.qty_size6,0)) as qty6,
sum(IFNULL(b.qty_size7,0) - IFNULL(c.qty_size7,0)) as qty7,
sum(IFNULL(b.qty_size8,0) - IFNULL(c.qty_size8,0)) as qty8,
sum(IFNULL(b.qty_size9,0) - IFNULL(c.qty_size9,0)) as qty9,
sum(IFNULL(b.qty_size10,0) - IFNULL(c.qty_size10,0)) as qty10,
b.kode_size1,
b.kode_size2,
b.kode_size3,
b.kode_size4,
...
left join trx_detail c on a.transaksi_kode=c.no_order and b.product_code = c.product_code
...
b.kode_size9,
b.kode_size10 
having (sum(IFNULL(b.qty,0) - IFNULL(c.qty,0)) <> 0)
";
