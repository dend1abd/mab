<?php 
	...
	if (isset($_POST["txtTgl1"])){
		...
		$sql = $sql . "where transaksi_tipe=7 ";
...
function frmNew(){  
    self.location="gudang_in_entry.php?op=1"; 
}
					...
					else
					{
						...
						while ($data = mysql_fetch_array($rs)) 
						{
							...
							<tr class='font10black' bgcolor='#ffffff'>
								...
								<td>
								<a href="gudang_in_entry.php?op=2&ID=<?php echo $data[0]?>">Edit</a> 
								|
								<a href="gudang_in_entry.php?op=3&ID=<?php echo $data[0]?>">Delete</a> 
								|
								<a href="gudang_in_entry.php?op=4&ID=<?php echo $data[0]?>">View</a> 
								</td>
							</tr>	
							<?php
						}					
