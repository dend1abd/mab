<?php
	...
	$_SESSION["errMsg"] 	= "";
	$_SESSION["transaksi_tipe"] ="14";
	
	$tableGen = "trx_gudang_bahan_out";
	$tableName = "trx_master";
	$tableGenDetail = "trx_gudang_bahan_out_detail";
	$tableNameDetail = "trx_detail";	
	$pageTitle = "Penerimaan Bahan Baku";
	$pagePrefix = "gudang_bahan_out";
...
{	
    ...
    if($_SESSION["op"] == "1" || $_SESSION["op"] == "2")
    {
        ...
        { 
			...
			$array2d[] = array("gudang_kode", "GD002", 1);
	...
	header("location:gudang_bahan_out_cetak.php?kode=" .$_SESSION["ID"]);
...
function frmCetak(){
	...
	//alert(kode );
	window.open("gudang_bahan_out_cetak.php?kode="+kode, "sales_order_" + kode ,  "height=360, width=640, location=0,menubar=0,scrollbars=1,resizable=0, modal=yes");
