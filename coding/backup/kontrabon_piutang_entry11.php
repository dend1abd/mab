						...
						<?php
							...
							else
							{
								...
								while ($datadetail = mysql_fetch_array($rsdetail)) 
								{
									...
									echo getTextBox($_SESSION["modeView"], "txtDetailjml_hutang$i", setNumber($datadetail["piutang"]), 50, 15, $clsformatIntegerReadOnly . " readonly");
									echo "</td>";
									
									echo "</tr>";
									
									$sumPiutang = $sumPiutang + $datadetail["piutang"];
								}
