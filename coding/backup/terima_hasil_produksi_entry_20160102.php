<?php
	...
	$_SESSION["errMsg"] 	= "";
	$_SESSION["transaksi_tipe"] ="21";
	
	$tableGen = "trx_terima_hasil_produksi";
	$tableName = "trx_master";
	$tableGenDetail = "trx_terima_hasil_produksi_det";
	$tableNameDetail = "trx_detail";	
	$pageTitle = "Penerimaan Barang Hasil Produksi";
				...
				<td colspan=2 valign="top">  
                    ...
                    <?php
						if ($_SESSION["modeView"] == "1")
						{
							...
							echo "<td width=3%><input class=\"button\" type=\"button\" name=\"btnLookUp\" value=\"...\" onClick=\"lookupWindow('product_lookup.php?tipe=" .$_SESSION["transaksi_tipe"]. "', 'product_list')\" /></td>";							
							$i = 0;
							mysql_data_seek($rsGenDetail, 0);						
							while ($dataGenDetail = mysql_fetch_array($rsGenDetail)) 
							{ 	
