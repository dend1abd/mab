<?php 
	...
	if (isset($_POST["txtTgl1"])){
		...
		if ($tipeLap == "1"){
			$sql = "select transaksi_kode, transaksi_tipe, transaksi_tgl, a.contact_code, sales_code, sub_total, sub_qty, disc_persen, disc_amount, ppn_persen, ppn_amount, total, bayar, sisa, keterangan, b.contact_name as supplier, c.contact_name as sales, stOrder, no_reff from trx_master a ";
			...
			$sql = $sql . "where transaksi_tipe=3 ";
...
<table width="100%" border="0" cellpadding="2" cellspacing="1">
	<tr>
		<td class="font12Bold" style="height: 24px"> Laporan Retur Pembelian</td>
	</tr> 
	<tr>
