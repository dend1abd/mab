...
function frmNew(){  
    self.location="jurnal_kas_entry.php?op=1"; 
}
...
<table width="100%" border="0" cellpadding="2" cellspacing="1">
	<tr>
		<td class="font12Bold">List Jurnal Kas</td>
	</tr> 
	<tr>
		<td>		
			<table >
					...
					else
					{
						...
						while ($data = mysql_fetch_array($rs)) 
						{
							...
							<tr class='font10black' bgcolor='#ffffff'>
								...
								<td>
								<a href="jurnal_kas_entry.php?op=2&ID=<?php echo $data[0]?>">Edit</a> 
								|
								<a href="jurnal_kas_entry.php?op=3&ID=<?php echo $data[0]?>">Delete</a> 
								|
								<a href="jurnal_kas_entry.php?op=4&ID=<?php echo $data[0]?>">View</a> 
								</td>
							</tr>	
							<?php
						}
