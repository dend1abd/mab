				...
				<td valign="top"> <!-- kanan-->
					<table width="100%">
                        ...
                        <td ></td>
						  ...
						  echo "<br />";
						  echo $dataCustomer["alamat"] . " " . $dataCustomer["kota"];
						  echo "<br />";
			...
			<tr >
				<td colspan=2 valign="top" width="100%" style='border-top: #B1B1B1 1px solid; border-bottom: #B1B1B1 1px solid' >  
					<table width="100%"  cellspacing="0" cellpadding="1"  bgcolor="silver" id="tblJurnalDetail" >  					
							...
							<td style='border-bottom: #B1B1B1 1px solid' >No Faktur</td> 
							<td style='border-bottom: #B1B1B1 1px solid' >Tgl Faktur</td>
							<td style='border-bottom: #B1B1B1 1px solid' >Jumlah</td>
							<td style='border-bottom: #B1B1B1 1px solid' >Sudah Bayar</td> 
							<td style='border-bottom: #B1B1B1 1px solid' >Piutang</td>
