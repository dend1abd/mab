<?php
	...
	else
	{
		...
		if ($_SESSION["op"] == "1")
		{
            ...
            $_SESSION["lblTitle"] = "New Data Merek Barang";
        }
        elseif($_SESSION["op"] == "2" || $_SESSION["op"]=="3" || $_SESSION["op"]=="4")
        {
			...
			if ($_SESSION["op"] == "2")
			{
                ...
                $_SESSION["lblTitle"]  = "Edit Data Merek Barang";
			}
			else
			{
				$_SESSION["modeView"] = "2";
                if ($_SESSION["op"] == "3")
                {
                    ...
                    $_SESSION["lblTitle"]  = "Delete Data Merek Barang";
                }
                else
                    $_SESSION["lblTitle"]  = "View Data Merek Barang";
			}
        }
        else    
            eror("invalid op");
...
{	
	...
	header('location:global_notification.php?from=merek_barang&strMsg=' . htmlspecialchars($strTemp));
...
<tr class="font10black">
          ...
          <td style="height: 23px">  Kode Merek</td>
          <td style="height: 23px">:</td>
