<?php
	...
	$_SESSION["errMsg"] 	= "";
	$_SESSION["transaksi_tipe"] ="10";
	
	$tableGen = "trx_gd_pro_in_non_order";
	$tableName = "trx_master";
	$tableGenDetail = "trx_gd_pro_in_non_order_det";
	$tableNameDetail = "trx_detail";	
	$pageTitle = "Penerimaan Barang Hasil Produksi non Order";
	$pagePrefix = "gudang_produksi_in_non_order";
...
{	
	...
	header("location:gudang_produksi_in_non_order_cetak.php?kode=" .$_SESSION["ID"]);
...
function frmCetak(){
	...
	//alert(kode );
	window.open("gudang_produksi_in_non_order_cetak.php?kode="+kode, "sales_order_" + kode ,  "height=360, width=640, location=0,menubar=0,scrollbars=1,resizable=0, modal=yes");
