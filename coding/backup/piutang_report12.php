...
, '' ket_bayar, a.contact_code, c.contact_name, d.total_retur, d.contact_name as sales_name, a.kode_wilayah
from trx_master a
left join 
(
								...
								if ($detilBayar ==0){
									...
									while ($bayar = mysql_fetch_array($rsBayar)) 
									{
										if($j==0){
											...
											echo "</tr><tr class='font10black' bgcolor='#ffffff'><td colspan=10>&nbsp;</td><td align='left' >" .$bayar["transaksi_kode"]. "</td>";
											echo "<td align='left' >" .$bayar["transaksi_tgl"]. "</td>";
											echo "<td align='right' >" .setNumber($bayar["jml_bayar"]). "</td>";
										}
										$j++;
