<?php 
	...
	cekSession();
	$tableWidth = "100%";
	$pageEdit = "terima_hasil_produksi_entry.php";
	$pageTitle = "List Penerimaan Hasil Produksi";
	...
	$array2d[] = array("Customet", "b.contact_name", "left", "varchar", "30%", "notsum");
	...
	$sql = $sql . "where transaksi_tipe=21 ";
