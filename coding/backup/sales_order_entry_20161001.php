...
{	
	...
	if($_SESSION["op"] == "1" || $_SESSION["op"] == "2")
		header('location:sales_order_notify.php?strMsg=' . htmlspecialchars($strTemp) . "&kode=" .$_SESSION["ID"]);
	else	
...
function frmCetakKartuProduksi(){
	kode = document.input.txttransaksi_kode.value;
	//alert(kode );
		...
		<table width="100%">
				...
				<td colspan=2 valign="top">  
                    ...
                    <?php
						if ($_SESSION["modeView"] == "1")
						{
							...
							for ($i=1;$i <= $nSize;$i++){
								echo "<td nowrap>";
								echo getTextBox($_SESSION["modeView"], "txtdetailsize" .$i. "_0", "", 10, 3, $clsReadOnly . " readonly"); 
								echo "x";
			...
			<tr>
				...
				?>
                  ...
                  <input class="button" type="button" name="btCetak" id="btCetak" value="Cetak Kartu Produksi" onClick="frmCetakKartuProduksi()" />&nbsp;&nbsp;&nbsp; 
                  <?php
				  }
				  ?>
				<?php
