<?php 
	...
	cekSession();
	$tableWidth = "100%";
	$pageEdit = "purchase_return_entry.php";
	$pageTitle = "List Transaksi Retur Pembelian";
	...
	$array2d[] = array("No Retur Pembelian", "transaksi_kode", "left", "varchar", "10%", "notsum");	
	$array2d[] = array("Tgl Retur Pembelian", "transaksi_tgl", "left", "varchar", "10%", "notsum");	
	$array2d[] = array("No Pembelian", "no_reff", "left", "varchar", "10%", "notsum");	
	$array2d[] = array("Tgl Pembelian", "tgl_reff", "left", "varchar", "10%", "notsum");	
