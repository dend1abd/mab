...
where a.transaksi_tipe=5 and a.transaksi_kode= '$no_order'
";
	...
	else
	{
		...
		while ($dataOrder = mysql_fetch_array($rsOrder)) 
		{
			...
			echo "</td>";
			echo "<td>";
			echo getTextBox("1", "txtdetailtotal_$i", setNumber($dataOrder["total"]), 15, 15, $clsformatIntegerReadOnly . " readonly"); 
			echo "</td>";
			...
			echo "<td>";
			echo getTextBox("1", "txtdetailno_order_$i", $dataOrder["transaksi_kode"], 12, 12, $clsReadOnly. " readonly"); 
			echo "</td>";		
		...
		$cssClass = $clsformatInteger;
		echo "<td>";
		echo getTextBox("1", "txtdetailqty_sum", setNumber($qty_sum), 3, 3, $clsformatIntegerReadOnly . " readonly"); 
		echo "</td>";
		echo "<td>";
		echo "</td>";
		echo "<td>";
		echo "</td>";
		echo "<td>";
		echo getTextBox("1", "txtdetailsub_total_sum", setNumber($sub_total_sum), 12, 12, $clsformatIntegerReadOnly . " readonly"); 
		echo "</td>";
		echo "<td>";
		echo "</td>";
		echo "<td>";
		echo getTextBox("1", "txtdetaildisc_amount_sum", setNumber($disc_amount_sum), 12, 12, $clsformatIntegerReadOnly . " readonly"); 
		echo "</td>";
		echo "<td>";
		echo getTextBox("1", "txtdetailtotal_sum", setNumber($total_sum), 15, 15, $clsformatIntegerReadOnly . " readonly"); 
		echo "</td>";
