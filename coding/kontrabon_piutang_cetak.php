			...
			<tr >
			    <td colspan=2 valign="top" width="100%" style='border-top: #B1B1B1 1px solid; border-bottom: #B1B1B1 1px solid; border-left: #B1B1B1 1px solid' height="200">  
					<table width="100%"  cellspacing="0" cellpadding="1"  bgcolor="silver" id="tblJurnalDetail" >  					
                            ...
                            <td style='border-bottom: #B1B1B1 1px solid; border-left: #B1B1B1 1px solid' >TglFaktur</td>
                            <td style='border-bottom: #B1B1B1 1px solid; border-left: #B1B1B1 1px solid' >Customer</td>
							<td style='border-bottom: #B1B1B1 1px solid; border-left: #B1B1B1 1px solid' >JumlahRp</td>							
							<td style='border-bottom: #B1B1B1 1px solid; border-left: #B1B1B1 1px solid' >JmlRetur</td>
                            <td style='border-bottom: #B1B1B1 1px solid; border-left: #B1B1B1 1px solid' >SdhBayar</td>
							<td style='border-bottom: #B1B1B1 1px solid; border-left: #B1B1B1 1px solid' >JmlPiutang</td> 
							<td style='border-bottom: #B1B1B1 1px solid; border-left: #B1B1B1 1px solid' >Sales</td>
