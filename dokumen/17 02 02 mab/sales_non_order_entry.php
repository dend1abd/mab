...
function frmCetak(kode){
	...
	//alert(kode );
	window.open("sales_by_order_cetak.php?kode="+kode, "sales_order_" + kode ,  "height=360, width=640, location=0,menubar=0,scrollbars=1,resizable=0, modal=yes");
	...
	<td height="250" valign="top" align="left">
		...
		<table width="100%">
			...
			<tr>
				<td colspan=2 align='center'> 
					 <?php 
				if ($_SESSION["op"] == "2" || $_SESSION["op"] == "3")
				{ 
				?>
