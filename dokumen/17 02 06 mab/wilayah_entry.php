<?php
	...
	else
	{
		...
		if ($_SESSION["op"] == "1")
		{
            ...
            $_SESSION["lblTitle"] = "New Data Wilayah";
        }
        elseif($_SESSION["op"] == "2" || $_SESSION["op"]=="3" || $_SESSION["op"]=="4")
        {
			...
			if ($_SESSION["op"] == "2")
			{
                ...
                $_SESSION["lblTitle"]  = "Edit Data Wilayah";
			}
			else
			{
				$_SESSION["modeView"] = "2";
                if ($_SESSION["op"] == "3")
                {
                    ...
                    $_SESSION["lblTitle"]  = "Delete Data Wilayah";
                }
                else
                    $_SESSION["lblTitle"]  = "View Data Wilayah";
			}
        }
        else    
            eror("invalid op");
...
{	
	...
	header('location:global_notification.php?from=Wilayah&strMsg=' . htmlspecialchars($strTemp));
...
<tr class="font10black">
          ...
          <td style="height: 23px">  Kode Wilayah</td>
          <td style="height: 23px">:</td>
...
<tr class="font10black">
          ...
          <td>  Nama Wilayah</td>
          <td>:</td>
          <td> <?php  echo getTextBox($_SESSION["modeView"], "txtReff", $_SESSION["Reff"], 80, 50, ""); ?> </td>
</tr >
