<?php
	...
	$sqlCmd = "select a.*, b.reff as nama_kota from mst_contact a left join mst_reff b on a.kota=b.kodereff and tipereff=11 where contact_code='$contact_code'"; 
