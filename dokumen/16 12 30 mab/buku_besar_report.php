<?php 
	...
	if (isset($_POST["txtTgl1"])){
		...
		$sql = "select tgl_transaksi, kodeac, b.perkiraan_name, no_transaksi, debet, kredit, ket, kodedc, no_reff from trx_besar a inner join mst_perkiraan b on a.kodeac=b.perkiraan_code" ; 
		$sql = $sql . " where tgl_transaksi between '$tgl1' and '$tgl2'"; 
		$sql = $sql . " and kodeac = '$perkiraancode'";
		if ($divisi !== "")  $sql = $sql . " and b.kode_divisi='$divisi' ";
		...
		<td>		
			<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#d29fec" align="left">
				...
				if (isset($_POST["txtTgl1"])){
					...
					echo "<td colspan=8>Saldo Awal</td>"; 
					...
					?>
					<tr >
						<td class='font10black' colspan="9" bgcolor="white" align="center">Data tidak ada</td> 
					</tr>
