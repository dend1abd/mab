<?php 
	...
	cekSession();
	$tableWidth = "100%";
	$pageEdit = "surat_jalan_cetak.php";
	$pageTitle = "List Surat Jalan";
	$transaksi_tipe = "19";	
	...
	$array2d[] = array("No Surat Jalan", "no_reff", "left", "varchar", "10%", "notsum");	
	$array2d[] = array("Tgl Cetak", "tgl_reff", "left", "varchar", "10%", "notsum");	
...
function frmCetak(kode){
	//alert(kode);
	window.open("surat_jalan_cetak.php?kode="+kode, "surat_jalan_" + kode,  "height=360, width=640, location=0,menubar=0,scrollbars=1,resizable=0, modal=yes");
}
